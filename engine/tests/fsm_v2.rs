...
fn hist2(json: &str, a: &str, b: &str) -> (Vec<f64>, Vec<f64>) {
    ...
    let cfg = RunConfig { n_realizations: Some(1), seed: Some(1), duration_override: None, timestep_override: None, results_spec: None, timebase: Default::default(), units: Default::default(), realization_weights: vec![], array_lane: false };
