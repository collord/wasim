...
fn run(json: &str) -> SimulationResults {
    ...
    let cfg = RunConfig { n_realizations: Some(1), seed: Some(1), duration_override: None, timestep_override: None, results_spec: None, timebase: Default::default(), units: Default::default(), realization_weights: vec![], array_lane: false, close_at_terminal: None };
