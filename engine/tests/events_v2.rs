...
fn run(json: &str, n: Option<u32>) -> SimulationResults {
    ...
    let cfg = RunConfig { n_realizations: n, seed: Some(7), duration_override: None, timestep_override: None, results_spec: None, timebase: Default::default(), units: Default::default(), realization_weights: vec![] };
