...
fn fn_name(f: &BuiltinFn) -> &'static str {
    match f {
        ...
        BuiltinFn::Erf => "erf",
        BuiltinFn::Erfc => "erfc",
        BuiltinFn::GetYear => "get_year",
        BuiltinFn::GetMonth => "get_month",
        BuiltinFn::GetDay => "get_day",
        BuiltinFn::GetHour => "get_hour",
        BuiltinFn::GetMinute => "get_minute",
        BuiltinFn::GetSecond => "get_second",
        BuiltinFn::PvFactor => "pv_factor",
        BuiltinFn::AnnuityFactor => "annuity_factor",
        BuiltinFn::TableMin => "table_min",
        BuiltinFn::TableMax => "table_max",
        BuiltinFn::ColumnCount => "column_count",
