...
type Panel = 'browse' | 'palette' | 'functions' | 'copilot'
const PANEL_LABELS: Record<Panel, string> = { browse: 'Browser', palette: 'Palette', functions: 'Functions', copilot: 'Copilot' }
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex border-b border-slate-200 text-[11px] font-medium">
        {(['browse', 'palette', 'functions', 'copilot'] as Panel[]).map((p) => (
      ...
      {panel === 'palette' ? (
        ...
        <div className="flex-1 overflow-hidden"><CopilotPanel /></div>
      ) : (
        <>
